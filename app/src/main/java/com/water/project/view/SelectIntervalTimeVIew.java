...
public class SelectIntervalTimeVIew extends Dialog implements View.OnClickListener {
    ...
    public SelectIntervalTimeVIew(Activity context, SelectObject selectObject) {
