...
//        sendData(BleContant.SEND_GET_CODE_PHONE,1); //发送蓝牙命令
    ...
    private void showData(String msg){
        ...
        tvMaiShen.setText(Double.parseDouble(MaiShen)+"");

        //显示压力值
        final String YaLi=msg.substring(52,61).replace("P","");
        tvYaLi.setText(Double.parseDouble(YaLi)+"");

        //显示气压值
        final String QiYa=msg.substring(61,68).replace("B","");
        tvQiYa.setText(Double.parseDouble(QiYa)+"");
        ...
        tvDianYa.setText(Double.parseDouble(DianYa)+"");
